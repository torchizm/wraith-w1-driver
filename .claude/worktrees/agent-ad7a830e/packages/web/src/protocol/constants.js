...
export const POLLING_RATE_MAP = {
    3: 125, 2: 250, 1: 500, 0: 1000, 6: 2000, 5: 4000, 4: 8000,
};
export const POLLING_RATE_REVERSE = {
...
export const DEFAULT_KEY_FUNCTIONS = {
...
export function getCommandIDs(isCustomer) {
    return {
